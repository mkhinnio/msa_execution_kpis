...
for i in range(0,len(partitioned_list)):  #len(partitioned_list)
...
df_fc_harmonized_costs_to_use_export_grouped_output.to_excel("output_costs_export_sample_all_years_" + date_today + ".xlsx")
