...
sef_actuals=actuals_revenues_grouped(conn)
...
#FC Billings 2024
df_power_query_allfinancials_billings=power_query_billings_csa(conn)
...
df_fc_outputs_grouped_contract_grouped=df_billings_fc_24_harmonized.groupby(["contract_number"]).aggregate({"billings":"sum"}).reset_index()
...
combined_grouped["accounted_amt_eur"]=combined_grouped["accounted_amt_eur"]*(-1)
combined_grouped.to_excel("output_contracts_2023_actuals_forecasts_revenues"+date_today+"_.xlsx")
